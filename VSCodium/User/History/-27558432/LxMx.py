...
def cadastro():
    if request.method == 'POST':
        try:
            ...
            cpf = request.form.get('cpf') # Use .get para não dar erro se não vier
            ...
            novo_usuario = Usuario(nome=nome, email=email, senha=senha, tipo=tipo, cpf=cpf) # Adicione cpf aqui
