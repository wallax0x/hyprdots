...
login_manager.login_message_category = "info" # Define a cor do alerta (azul)
# ---------------------------
...
@app.route('/editar_perfil', methods=['POST']) #editar o perfil
@login_required
def editar_perfil():
    try:
        ...
        # Se for profissional, atualiza os dados extras
